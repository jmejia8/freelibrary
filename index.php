...
<div id="about_bio_layer">
	<div class="left e20">
		<h1><span class="blue">Sobre</span> Mi</h1>
		<p class="red">Biograf&iacute;a r&aacute;pida</p>
	</div>
	<div class="left e80">
		<p>
...
<div id="about_project_layer">
	<div class="left e20">
		<h1><span class="blue">El</span> proyecto</h1>
		<p class="red">Por qu&eacute; esta p&aacute;gina</p>
	</div>
	<div class="left e80">
		<p>
...
<div id="subfooter">
  <div id="subfooter_content">
    ...
    <div class="menu-menu-navegacion-container"><ul id="menu-menu-navegacion-1" class="menu"><li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-807"><a href="../index.html">Inicio</a></li>
...
<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-47 current_page_item menu-item-809"><a href="index.html">Sobre mí</a></li>
